...
#define LCD_ADDR ((U32)LCD_BUFFER_CAM)
...
void Test_CamPreview(void)
{
	...
	LCD_Init();
#if defined(LCD_N35) || defined(LCD_T35) || defined(LCD_X35) || defined(LCD_TD35)
...
//		rCIGCTRL &= ~(1<<26); // inverse PCLK, test pattern
	...
	case CAM_OV7620:
		...
		CamInit(640, 480, 640, 480, 0, 0,  CAM_FRAMEBUFFER_C, CAM_FRAMEBUFFER_P);
		...
		CamInit(480, 272, 320, 240, 0, 0,  CAM_FRAMEBUFFER_C, CAM_FRAMEBUFFER_P);
#endif		
		break;
	//---
	default : 	
