...
#if defined(LCD_N35) + defined(LCD_L80) + defined(LCD_T35) + defined(LCD_X35) + defined(LCD_A70) + defined(LCD_VGA1024768) + defined(LCD_W35) +defined(LCD_N43) + defined(LCD_S70) + defined(LCD_W50) + defined(LCD_H43) \
  + defined(LCD_P43) + defined(LCD_P35) + defined(LCD_TD35) != 1
...
#elif defined(LCD_W50)
#define LCD_WIDTH 800
#define LCD_HEIGHT 480

#define LCD_PIXCLOCK 1

#define LCD_RIGHT_MARGIN 65
#define LCD_LEFT_MARGIN  30 //40
#define LCD_HSYNC_LEN    25 //31

#define LCD_UPPER_MARGIN 25
#define LCD_LOWER_MARGIN 5
#define LCD_VSYNC_LEN 1

#elif defined(LCD_H43)
#define LCD_WIDTH 480
#define LCD_HEIGHT 272

#define LCD_PIXCLOCK 3
...
#elif defined(LCD_P35)
#define LCD_WIDTH 320
#define LCD_HEIGHT 240

#define LCD_PIXCLOCK 6

#define LCD_RIGHT_MARGIN 0x05
